...
class TurnoFormulario (ctk.CTkFrame) :
    ...
    def pantalla_principal (self) : 
        ...
        self.combo_cliente = ctk.CTkComboBox(self, values=[cliente.nombre for cliente in self.clientes])
        ...
        self.combo_servicio = ctk.CTkComboBox(self, values=[servicio.nombre for servicio in self.servicios])
        ...
        self.boton_asignar = ctk.CTkButton(self, text="Asignar Turno", command=self.asignar_turno)
        self.boton_asignar.grid(row=5, column=0, columnspan=2, pady=10)
...
class TurnoLista (ctk.CTkFrame) :
    ...
    def pantalla_turnos_asignados (self) : 
        ...
        self.boton_eliminar = ctk.CTkButton(self, text="Eliminar Turno", command=self.eliminar_turno)
        self.boton_eliminar.pack(pady=3)

        self.boton_exportar = ctk.CTkButton(self, text="Exportar a Excel", command=self.exportar)
        self.boton_exportar.pack(pady=3)
